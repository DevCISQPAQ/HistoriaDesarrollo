...
<body class="bg-gray-50 font-sans">
    <div class="min-h-screen flex flex-col">
        <!-- Encabezado -->
        <header class="bg-[#5D7E8D] text-white py-4 shadow-md flex justify-center items-center gap-4">
        ...
        <main class="flex-1 container mx-auto px-4 sm:px-6 py-8 md:py-12">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden md:flex md:flex-row-reverse animate-fade-in">
                    <!-- Imagen decorativa -->
                    <div class="md:w-1/2 bg-gradient-to-br from-[#5D7E8D] to-[#213d78] p-6 flex items-center justify-center">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#5D7E8D]">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#5D7E8D] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#213d78]">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#213d78] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#FF6B6B]">
                        <div class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#FF6B6B] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Pie de página -->
        <footer class="bg-[#213d78] text-white text-center py-4 mt-8">
