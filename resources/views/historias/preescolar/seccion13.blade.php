...
<div class="p-6">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6">
        <div class="flex items-center">
            <span class="bg-[#5D7E8D] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">13</span>
            <h2 class="text-xl font-bold text-[#1f355e]">Historia Escolar</h2>
        </div>
    ...
    <form action="#" method="POST">
        ...
        <div class="flex justify-between mt-8 gap-2">
            <a href="{{ route('preescolar.seccion12') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition flex items-center">
            ...
            <a href="{{ route('preescolar.seccion14') }}" class="px-6 py-2 bg-[#ff7843] text-white rounded-lg hover:bg-[#ffaf25] transition flex items-center shadow-md">
