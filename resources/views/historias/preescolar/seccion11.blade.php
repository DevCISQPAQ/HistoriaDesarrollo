...
<div class="p-6">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6">
        <div class="flex items-center">
            <span class="bg-[#5D7E8D] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">11</span>
            <h2 class="text-xl font-bold text-[#1f355e]">Salud</h2>
        </div>
    ...
    <form action="#" method="POST">
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-2 pt-4">
                <label class="inline-flex items-center"> Especifique si ha presentado alguno de los siguientes problemas:</label>
                <div class="space-y-2">
            ...
            <div>
                ...
                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
                    id="otrosprob" name="otrosprob" required>
            </div>

            <div>
                <label for="enfeotrastor" class="block text-sm font-medium text-gray-700 pt-3">Padece, o ha padecido, alguna enfermedad o trastorno que requiera de atencion medica especializada?</label>
            ...
            <div>
                <label for="tipoterapia" class="block text-sm font-medium text-gray-700 pt-3">Recibe, o ha recibido, algun tipo de terapia (emocional, motriz, de lenguaje, de aprendizaje)? Describa el tipo y desde cuando</label>
                <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
        ...
        <div class="flex justify-between mt-8 gap-2">
            <a href="{{ route('preescolar.seccion10') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition flex items-center">
            ...
            <a href="{{ route('preescolar.seccion12') }}" class="px-6 py-2 bg-[#ff7843] text-white rounded-lg hover:bg-[#ffaf25] transition flex items-center shadow-md">
