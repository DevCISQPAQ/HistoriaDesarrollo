...
<div class=" bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <form action="#" method="POST">
        ...
        <div class="flex justify-between mt-8 gap-2 m-4">
            <a href="{{ route('preescolar.seccion9') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition flex items-center">
            ...
            <a href="{{ route('preescolar.seccion11') }}" class="px-6 py-2 bg-[#ff7843] text-white rounded-lg hover:bg-[#ffaf25] transition flex items-center shadow-md">
