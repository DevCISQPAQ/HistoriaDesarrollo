...
<div class="p-6">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6">
        <div class="flex items-center">
            <span class="bg-[#5D7E8D] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">10</span>
            <h2 class="text-xl font-bold text-[#1f355e]">Sueño</h2>
        </div>
