...
<div class=" bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <form action="#" method="POST">
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto m-4">
            ...
            <div>
                <label for="desa-visual" class="block text-sm font-medium text-gray-700 pt-3">Describa si ha experimentado algun problema visual<span class="text-red-500">*</span></label>
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto m-4">
            ...
            <div>
                <label for="desa-auditivo" class="block text-sm font-medium text-gray-700 pt-3">Describa si ha experimentado algun problema de oido (operaciones, infecciones, drenajes, etc.)<span class="text-red-500">*</span></label>
                <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
