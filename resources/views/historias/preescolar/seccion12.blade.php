...
<div class=" bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <form action="{{ route('preescolar.seccion12.guardar') }}" method="POST" class="p-6">
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto m-4">
            ...
            <div>
                <label for="reaccprimer" class="block text-sm font-medium text-gray-700 pt-3">Como reacciono en su primer ingreso a la escuela? <span class="text-red-500">*</span></label>
