...
<div class="p-6">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6">
        <div class="flex items-center">
            <span class="bg-[#5D7E8D] text-white rounded-full w-8 h-8 flex items-center justify-center mr-3 font-bold">4</span>
            <h2 class="text-xl font-bold text-[#1f355e]">Dinamica Familiar</h2>
        </div>
    ...
    <form action="#" method="POST">
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto">
            ...
            <div> <!-- radiobutton -->
                <label class="block text-sm font-medium text-gray-700 py-2">Como calificaria la adaptacion general de su hijo(a) en la casa?:</label>
                <div class="md:flex-1">
                ...
                <div>
                    <label for="califica-adaptacion-porq" class="block text-sm font-medium text-gray-700 pt-3">Por que?:</label>
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="relacion-familia-madre" class="block text-sm font-medium text-gray-700 pt-3">Madre:</label>
                ...
                <div>
                    <label for="relacion-familia-padre" class="block text-sm font-medium text-gray-700 pt-3">Padre:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
                        id="relacion-familia-padre" name="relacion-familia-padre" placeholder="Escribe aqui la respuesta" required></textarea>
                </div>
                <div>
                    <label for="relacion-familia-hermanos" class="block text-sm font-medium text-gray-700 pt-3">Hermanos:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="diferencia-estilos" class="block text-sm font-medium text-gray-700 pt-3">Al presentarse alguna diferencia referente a los estilos de diciplina entre ellos, Como se maneja tal desacuerdo?:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-6 relative overflow-x-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="responde-desobede" class="block text-sm font-medium text-gray-700 pt-3">Como responden, usted y su conyuge, cuando su hijo(a) desobedece a sus indicaciones?:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
                        id="responde-desobede" name="responde-desobede" placeholder="Escribe aqui la respuesta" required></textarea>
                </div>
                <div>
                    <label for="sanciones-casa" class="block text-sm font-medium text-gray-700 pt-3">Cuales son las sanciones que comunmente se manejan en casa y como responde su hijo(a) ante ellas?:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
                        id="sanciones-casa" name="sanciones-casa" placeholder="Escribe aqui la respuesta" required></textarea>
                </div>
            </div>
            <div>
                <label for="sanciones-conductas" class="block text-sm font-medium text-gray-700 pt-3">Las conductas que se sancionas son:</label>
        ...
        <div class="mb-8 border border-gray-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="docil-desafiante" class="block text-sm font-medium text-gray-700 pt-3">Considera que su hijo(a) es docil a las normas que se le marcan o suele ser desafiante al respecto?:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
                        id="docil-desafiante" name="docil-desafiante" placeholder="Escribe aqui la respuesta" required></textarea>
                </div>
                <div>
                    <label for="evento-traumatico" class="block text-sm font-medium text-gray-700 pt-3">Ha habido algun evento traumatico o significativo en la familia durante el desarrollo de su hijo(a)? Describa:</label>
                    <textarea rows="2" class=" w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1f355e] focus:border-[#1f355e] transition"
